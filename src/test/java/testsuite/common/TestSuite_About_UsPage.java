...
public class TestSuite_About_UsPage extends BaseTestClass {
	  ...
	  @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_001_Validate_About_Us_Btn() {
	  ...
	  @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_002_Validate_Org_Lnk() {
	        ActionHelper.clearCookies();
	        ActionHelper.openURL(Constants.Urls.URL_HOMEPAGE);
	        HomePage homePage= HomePage.getInstance();
	        homePage.click_About_Us();
	  ...
	  @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_003_Validate_GenoSmart_Lnk() {
	        ActionHelper.clearCookies();
	        ActionHelper.openURL(Constants.Urls.URL_HOMEPAGE);
	        HomePage homePage= HomePage.getInstance();
	        homePage.click_About_Us();
	  ...
	  @Test(dependsOnMethods="TC_003_Validate_GenoSmart_Lnk",groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_004_Validate_ARLG_CRACKLE_Lnk() {
	        ActionHelper.clearCookies();
	        ActionHelper.openURL(Constants.Urls.URL_HOMEPAGE);
	        HomePage homePage= HomePage.getInstance();
	        homePage.click_About_Us();
	  ...
	  @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_005_Validate_publication_Lnk() {
	        ActionHelper.clearCookies();
	        ActionHelper.openURL(Constants.Urls.URL_HOMEPAGE);
	        HomePage homePage= HomePage.getInstance();
	        homePage.click_About_Us();
	  ...
	  @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_006_Validate_pipeline_Lnk() {
	        ActionHelper.clearCookies();
	        ActionHelper.openURL(Constants.Urls.URL_HOMEPAGE);
	        HomePage homePage= HomePage.getInstance();
	        homePage.click_About_Us();
	  ...
	  @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_007_Validate_wiki_Lnk() {
	        ActionHelper.clearCookies();
	        ActionHelper.openURL(Constants.Urls.URL_HOMEPAGE);
	        HomePage homePage= HomePage.getInstance();
	        homePage.click_About_Us();
	  ...
	  @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY},
	    ...
	    public void TC_008_Validate_superscript_Lnk() {
	        ActionHelper.clearCookies();
	        ActionHelper.openURL(Constants.Urls.URL_HOMEPAGE);
	        HomePage homePage= HomePage.getInstance();
	        homePage.click_About_Us();
